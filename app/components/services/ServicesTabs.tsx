                    ...
                    <div className="grid md:grid-cols-5 grid-col-1 gap-4">
                        <div className="col-span-3">
                            ...
                            <div className="flex lg:justify-start justify-center">
                                <Button outline href="/service-detail"
                                    color="default"
                                    size="lg"
                                    className="px-6 py-3 h-10 text-lg font-semibold shadow-lg my-8 inline-flex"
                                >
                                    Read More
                                </Button>
                            </div>
                        ...
                        <div className="lg:col-span-2 col-span-3 flex justify-center">
                            <div className="relative w-[280px] sm:w-[220px] md:w-[350px] lg:aspect-[12/16.5]  aspect-[12/16.5]  border-4 border-white shadow-lg overflow-hidden s mx-auto">
                                {/* Background Image */}
                                <img
                                ...
                                <div className="absolute inset-0 bg-black/0 hover:bg-black/50 transition-all duration-300"></div>
            ...
            <TabItem title="Weight Loss">
                <Card className="bg-white rounded-2xl p-5 text-center shadow-lg border-0">
                    <div className="grid md:grid-cols-5 grid-col-1 gap-4">
                        ...
                        <div className="lg:col-span-2 col-span-3 flex justify-center">
                            <div className="relative w-[280px] sm:w-[220px] md:w-[350px]  lg:aspect-[12/16.5]  aspect-[12/16.5]   border-4 border-white shadow-lg overflow-hidden  mx-auto">
                                {/* Background Image */}
                                <img
                                    className="absolute inset-0 w-full h-full object-cover"
                                    src="/wl.jpg"
                    ...
                    <div className="grid md:grid-cols-5 grid-col-1 gap-4">
                        <div className="col-span-3">
                            ...
                            <div className="flex lg:justify-start justify-center">
                                ...
                                <Button outline
                                    color="default" href="/service-detail"
                                    size="lg"
                                    className="px-6 py-3 h-10 text-lg font-semibold shadow-lg my-8 inline-flex justify-start"
                                >
                                    Read More
                                </Button>
                            </div>
