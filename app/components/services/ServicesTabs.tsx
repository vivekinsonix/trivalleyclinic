...
export function Servicestabs() {
    return (
        <Tabs aria-label="Tabs with icons" variant="underline">
         ...
         <div className="relative w-[280px] sm:w-[220px] md:w-[350px] lg:aspect-[10/16.5]  aspect-[12/19.5] rounded-[2.5rem] border-4 border-gray-800 overflow-hidden shadow-2xl mx-auto">
  {/* Background Image */}
  <img
  ...
  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-6 bg-gray-800 rounded-b-xl"></div>
            ...
            <TabItem title="Weight Loss">
                ...
                <div  className="lg:col-span-2 col-span-3 flex justify-center">
         <div className="relative w-[280px] sm:w-[220px] md:w-[350px] aspect-[10/16.5] rounded-[2.5rem] border-4 border-gray-800 overflow-hidden shadow-2xl mx-auto">
  {/* Background Image */}
  <img
    className="absolute inset-0 w-full h-full object-cover"
    src="/wl.jpg"
