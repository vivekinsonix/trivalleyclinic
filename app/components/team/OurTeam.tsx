...
export default function Ourteam() {
    return (
        <section
            className="relative w-full bg-gradient-to-l from-primarylight via-primarylight to-secondary/30 bg-cover bg-center flex items-center justify-center" id="doctors"
